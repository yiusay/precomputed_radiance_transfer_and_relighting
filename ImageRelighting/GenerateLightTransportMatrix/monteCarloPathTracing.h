...
extern unsigned char* LoadPngData(WCHAR *filename, unsigned int &img_width, unsigned int &img_height);
...
extern void OutputWeightIntoFile(double *eye, GLfloat *image, ofstream **path_tracing_data);
